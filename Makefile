...
download-package:
	...
	curl -o ${ROOT_DIR}/npm/${NPM_PACKAGE_NAME}@${NPM_PACKAGE_VERSION}/package.json https://cdn.jsdelivr.net/npm/${NPM_PACKAGE_NAME}@${NPM_PACKAGE_VERSION}/package.json
	cp ${ROOT_DIR}/npm/${NPM_PACKAGE_NAME}@${NPM_PACKAGE_VERSION}/package.json ${ROOT_DIR}/manifests/${NPM_PACKAGE_NAME}@${NPM_PACKAGE_VERSION}/package.json
